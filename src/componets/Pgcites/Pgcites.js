...
const Pgcites = () => {
    ...
    const malefilter = () => {
        var newdata = data.filter(function (a) {
            return a.Gender.toLowerCase() === 'male' && a.city.toLowerCase() === `${city.toLowerCase()}`;
        })
    ...
    const femalefilter = () => {
        ...
        var newdata = data.filter(function (a) {
            return a.Gender.toLowerCase() === 'female' && a.city.toLowerCase() === `${city.toLowerCase()}`;
        })
    ...
    const unisexfilter = () => {
        var newdata = data.filter(function (a) {
            return a.Gender.toLowerCase() === 'unisex' && a.city.toLowerCase() === `${city.toLowerCase()}`;
        })
    ...
    const under5000filter = () => {
        ...
        if (genderfilter === 'male') {
            newdata = data.filter(function (a) {
                return a.Gender.toLowerCase() === 'male' && a.city.toLowerCase() === `${city.toLowerCase()}` && a.Price < 5000
            });
        }
        else if (genderfilter === 'female') {
            newdata = data.filter(function (a) {
                return a.Gender.toLowerCase() === 'female' && a.city.toLowerCase() === `${city.toLowerCase()}` && a.Price < 5000
            });
        }

        else if (genderfilter === 'unisex') {
            newdata = data.filter(function (a) {
                return a.Gender.toLowerCase() === 'unisex' && a.city.toLowerCase() === `${city.toLowerCase()}` && a.Price < 5000;
            });
        }
        else if (genderfilter === 'all') {
            newdata = data.filter(function (a) {
                return a.city.toLowerCase() === `${city.toLowerCase()}` && a.Price < 5000;
            });
        }
    ...
    const val5000to7500filter = () => {
        ...
        if (genderfilter === 'male') {
            newdata = data.filter(function (a) {
                return a.Gender.toLowerCase() === 'male' && a.city.toLowerCase() === `${city.toLowerCase()}` && a.Price >= 5000 && a.Price < 7500
            });
        }
        else if (genderfilter === 'female') {
            newdata = data.filter(function (a) {
                return a.Gender.toLowerCase() === 'female' && a.city.toLowerCase() === `${city.toLowerCase()}` && a.Price >= 5000 && a.Price < 7500
            });
        }

        else if (genderfilter === 'unisex') {
            newdata = data.filter(function (a) {
                return a.Gender.toLowerCase() === 'unisex' && a.city.toLowerCase() === `${city.toLowerCase()}` && a.Price >= 5000 && a.Price < 7500
            });
        }
        else if (genderfilter === 'all') {
            newdata = data.filter(function (a) {
                return a.city.toLowerCase() === `${city.toLowerCase()}` && a.Price >= 5000 && a.Price < 7500
            });
        }
    ...
    const val7500to10000filter = () => {
        ...
        if (genderfilter === 'male') {
            newdata = data.filter(function (a) {
                return a.Gender.toLowerCase() === 'male' && a.city.toLowerCase() === `${city.toLowerCase()}` && a.Price >=7500  && a.Price < 10000
            });
        }
        else if (genderfilter === 'female') {
            newdata = data.filter(function (a) {
                return a.Gender.toLowerCase() === 'female' && a.city.toLowerCase() === `${city.toLowerCase()}` && a.Price >=7500  && a.Price < 10000
            });
        }

        else if (genderfilter === 'unisex') {
            newdata = data.filter(function (a) {
                return a.Gender.toLowerCase() === 'unisex' && a.city.toLowerCase() === `${city.toLowerCase()}` && a.Price >=7500  && a.Price < 10000
            });
        }
        else if (genderfilter === 'all') {
            newdata = data.filter(function (a) {
                return a.city.toLowerCase() === `${city.toLowerCase()}`&& a.Price >=7500  && a.Price < 10000
            });
        }
    ...
    const morethan10000filter = () => {
        ...
        if (genderfilter === 'male') {
            newdata = data.filter(function (a) {
                return a.Gender.toLowerCase() === 'male' && a.city.toLowerCase() === `${city.toLowerCase()}` && a.Price >= 10000
            });
        }
        else if (genderfilter === 'female') {
            newdata = data.filter(function (a) {
                return a.Gender.toLowerCase() === 'female' && a.city.toLowerCase() === `${city.toLowerCase()}` && a.Price >= 10000
            });
        }

        else if (genderfilter === 'unisex') {
            newdata = data.filter(function (a) {
                return a.Gender.toLowerCase() === 'unisex' && a.city.toLowerCase() === `${city.toLowerCase()}` && a.Price >= 10000
            });
        }
        else if (genderfilter === 'all') {
            newdata = data.filter(function (a) {
                return a.city.toLowerCase() === `${city.toLowerCase()}` && a.Price >= 10000
            });
        }
